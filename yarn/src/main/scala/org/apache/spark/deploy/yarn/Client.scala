...
private[spark] class Client(
  ...
  private def setupLaunchEnv(
    ...
    populateClasspath(args, myYarnConf, sparkConf, env, sparkConf.get(DRIVER_CLASS_PATH))
  ...
  : ContainerLaunchContext = {
    ...
    val launchEnv = setupLaunchEnv(myYarnConf, appStagingDirPath, pySparkArchives)

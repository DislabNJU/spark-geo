...
/** Provides utility functions to be used inside SparkRecoverySubmit. */
private[spark] object SparkSubmitUtils {

  // Exposed for testing
  var printStream = SparkRecoverySubmit.printStream
  ...
  /**
    ...
    * (will append to jars in SparkRecoverySubmit).
